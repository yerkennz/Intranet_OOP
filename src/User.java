...
public class User implements Serializable, Comparable{
	...
	public User(String name, String surname, int id, Date birthDay, String phoneNumber, String email) {
		this.name = name;
		this.surname = surname;
		this.id = id;
		this.birthDay = birthDay;
		this.login = this.name.substring(0, 1).toLowerCase() + "_" + this.name.toLowerCase();
